	...
	$('audio[controls]').before(function(){
		...
		var addRecord = function() {
			var record = document.createElement('button');
				...
				record.setAttribute('id', $(song).data('infoRecord'));
				record.setAttribute('seed', $(song).data('infoSeed'));
				record.setAttribute('collective', $(song).data('infoCollective'));
		...
		var addData = function() {
			...
			if (typeof($(song).data('infoArtist')) !== 'undefined'){ addInfo('Initiator', 'infoArtist');}
			if (typeof($(song).data('infoTitle')) !== 'undefined'){ addInfo('Title', 'infoTitle');}
			if (typeof($(song).data('infoAlbumTitle')) !== 'undefined'){ addInfo('Description', 'infoAlbumTitle');}
